...
public class AnalyzeTest {
    ...
    @Test
    public void whenListOfSubjectAverageForThree() {
        List<Tuple> average = Analyze.averageScoreByPupil(
                List.of(
                        new Pupil("Ivanov", List.of(new Subject("Math", 60), new Subject("Lang", 60))),
                        new Pupil("Ivanova", List.of(new Subject("Math", 30), new Subject("Lang", 30))),
                        new Pupil("Petrov", List.of(new Subject("Math", 90), new Subject("Lang", 90)))
                ).stream()
        );
        assertThat(average, is(List.of(
                new Tuple("Lang", 60D),
